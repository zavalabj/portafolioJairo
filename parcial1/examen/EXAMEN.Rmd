...
#Trasponer las columnas del df para que las características de 
#cada observacion estén ordenadas por columnas 
...
names(df_transposed_omitted) <- c("Peso","Estatura",
                                  "Edad","Complexión",
                                  "Papás_separados","Cantidad_hermanos",
                                  "Trabaja", "Horas_trab_dia", 
