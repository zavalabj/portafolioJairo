...
##1.4 Construyan diferentes gráficos donde puedan mostrar patrones y detalles de la base
#de datos con respecto a una nueva variable que podemos denominar: “categoría”
```{r, echo=TRUE,warning=FALSE,tidy=TRUE}
