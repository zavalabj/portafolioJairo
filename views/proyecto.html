...
<body>
  ...
  <div class="w3-top">
    <div class="w3-bar w3-white w3-wide w3-padding w3-card">
      <a href="http://localhost:8989" class="w3-bar-item w3-button"><b>Byte</b> Miners</a>
    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
        <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
          <img class="w3-display-container w3-center" src="/views/images/proyblanco.png" alt="Logo" width="500"
            height="300">
        </div>
      </div>
    </div>
  ...
  <div class="w3-content w3-padding" style="max-width:1000px">
    <h1 class="w3-border-bottom w3-border-light-grey w3-padding-16">Título</h1>
    <!-- About Section -->
    <div class="w3-container w3-padding-32" id="about">
      <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Descripción</h3>
      <font color="#525254">
    ...
    <div class="w3-display-container w3-center">
      <img src="/views/images/evidencia.png" class="w3-image" style="width:70%">
    </div>
    <!-- Code Section  -->

    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Código</h3>
    ...
    <!-- Conclusion Section  -->
    <div class="w3-container w3-padding-32" id="conclusion">
      <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Conclusión</h3>
      <font color="#525254">
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
          magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
          consequat. Excepteur sint
  ...
  <script
    src="https://cdn.rawgit.com/google/code-prettify/master/loader/run_prettify.js?lang=c&amp;skin=sons-of-obsidian"></script>
